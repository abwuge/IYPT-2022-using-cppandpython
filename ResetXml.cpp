...
Cylinder::Cylinder()
{
	this->height = (double)0.2;
	this->radius = (double)0.1732;
	this->mass = (double)1.0;
	...
	this->inertial_origin_z = (double)1.0 / (double)2.0 * this->height;
	...
	this->inertia_ixy = (double)0.0;
	this->inertia_ixz = (double)0.0;
	this->inertia_iyz = (double)0.0;
	this->i_o_x_s << this->inertial_origin_x << " " << this->inertial_origin_y << " " << this->inertial_origin_z;
	this->i_o_x_s >> this->inertial_origin_xyz;
}
Cylinder::Cylinder(double height, double radius,double mass)
{
	this->height = height;
	this->radius = radius;
	this->mass = mass;
